...
$.ajax({
    ...
    data: {
        key: '2ZFBZ-HWPKI-6INGV-UUB4I-BS2DE-T4BJA',  // 这里要写你的KEY!!!
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.36611, 39.91231, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    else if (date.getHours() >= 15 && date.getHours() < 16) timeChange = "<span>三点多啦</span>，一起饮茶呀！";
...
if (localStorage.getItem("blogbg") != undefined) {
    ...
    --default-bg: url(https://blog-1308477074.cos.ap-beijing.myqcloud.com/images/arcane-kid-jinx-finger-gun-4k-wallpaper-3840x2160.jpg);
    --darkmode-bg:url(https://blog-1308477074.cos.ap-beijing.myqcloud.com/images/arcane-kid-jinx-finger-gun-4k-wallpaper-3840x2160.jpg);
